...
byte_t
getFileCURL(string_t url, string_t file)
{
...
void
init_data_buffer(dataBuffer_t * s)
{
  s->len = 0;
...
size_t
writefunc(voidPtr_t ptr, size_t size, size_t nmemb, dataBuffer_t * s)
{
...
string_t
compone_URL(const twitterURLS_t * twURLS, const ProtocolType_t protocolType,
    const string_t urlPath, ApiFormatType_t apiFormatType, int api)
{
  string_t url = NULL;
...
string_t
componeOAUTH_URL(const twitterURLS_t * twURLS,
...
string_t
componeAPI_URL(const twitterURLS_t * twURLS, const ProtocolType_t protocolType,
    const string_t urlPath, ApiFormatType_t apiFormatType)
{
