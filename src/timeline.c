...
string_t getRawTimeline(const twitterURLS_t *twURLS, timelineType_t timelineType, const user_t* user)
{
 ...
 *
 */
string_t updateStatus(const twitterURLS_t *twURLS, const user_t *user, const string_t msg)
{
